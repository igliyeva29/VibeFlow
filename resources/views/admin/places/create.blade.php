    ...
    <div class="container-xxl">
        ...
        <form action="{{ route('admin.places.store') }}" method="POST">
            ...
            <div class="row justify-content-center">
                <div class="col">
                    <div class="mb-3">
                        <label for="categoryId" class="form-label">@lang('app.category') : </label>
                    ...
                    <div class="mb-3">
                        <label for="title" class="form-label"> @lang('app.title')<span class="text-danger">*</span> :
                        </label>
                        <input type="text" class="form-control" id="title" name="title">
                    </div>
                    <div class="mb-3">
                        <label for="titleTm" class="form-label"><span class="text-primary"><i class="bi bi-translate"></i>
                                tm</span> @lang('app.titleTm') : </label>
                        <input type="text" class="form-control" id="titleTm" name="titleTm">
                    </div>
                    <div class="mb-3">
                        <label for="titleRu" class="form-label"><span class="text-primary"><i class="bi bi-translate"></i>
                ...
                <div class="col">
                    <div class="mb-3">
                        <label for="locationId" class="form-label">@lang('app.location')<span class="text-danger">*</span> :
                        </label>
                    ...
                    <div class="mb-3">
                        <label for="adress" class="form-label"> @lang('app.address')<span class="text-danger">*</span> :
                        </label>
                        <input type="text" class="form-control" id="address" name="address">
                    </div>
                    <div class="mb-3">
                        <label for="phoneNumber" class="form-label"> @lang('app.phoneNumber')<span class="text-danger">*</span> :
                        </label>
                    ...
                    <div class="mb-3">
                        <label for="imstagramProfile" class="form-label"> @lang('app.instagramProfile') </label>
